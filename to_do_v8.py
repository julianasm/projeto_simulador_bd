...
class Projeto:
    ...
    def __iter__(self):
        ...
        #com essa função o objeto se torna iteravel e nao é mais necessario 
        #fazer 'for tarefa in casa.tarefas', porque o 'casa' sozinho já é iteravel
...
def main():
    ...
    mercado.add('Arroz')
    mercado.add('Feijão', datetime.now() + timedelta(days=3, minutes=12))
    print(mercado)

    mercado.procurar('Arroz').concluir()
